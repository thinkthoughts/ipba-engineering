...
- `00_engineering_context.ipynb` — engineering context for benefit distribution as an engineering variable.
- `01_constraints.ipynb` — deployment constraints and admissible engineering assumptions.
- `07_connected_lanes.ipynb` — connected deployment lanes linking policy, telemetry, benefit distribution, and development indicators.
...
- `19_distribution.ipynb` — benefit distribution as an engineering object and measurable state.
- `23_dynamics.ipynb` — dynamics of benefit distribution under deployment constraints.
- `29_optimization.ipynb` — optimization of benefit distribution subject to engineering constraints.
