...
- `00_engineering_context.ipynb` — engineering context for information bundling as an engineering variable.
- `01_constraints.ipynb` — deployment constraints and admissible engineering assumptions.
- `07_connected_lanes.ipynb` — connected deployment lanes linking policy, telemetry, information bundling, and development indicators.
...
- `19_distribution.ipynb` — information bundling as an engineering object and measurable state.
- `23_dynamics.ipynb` — dynamics of information bundling under deployment constraints.
- `29_optimization.ipynb` — optimization of information bundling subject to engineering constraints.
